      ...
      <ScrollView>
        <Card style={styles.container}>
          <View style={styles.subContainer}>
            ...
            <View>
              <Text h5>{this.state.product.image}</Text>
            </View>
            <View>
              <Text h4>{this.state.product.price}</Text>
            </View>
          </View>
            ...
            <Button
              ...
              onPress={() => {
                this.props.navigation.navigate('EditProduct', {
                  productkey: `${JSON.stringify(this.state.key)}`,
                });
              }} />
          </View>
          <View style={styles.detailButton}>
            <Button
              ...
              name='Delete'
              onPress={() => this.deleteProduct(this.state.key)} />
          </View>
        </Card>
      </ScrollView>
    );
